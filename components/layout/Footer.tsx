    ...
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div>
            <Link href="/" className="mb-4 flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-white">
                LaserCalc <span className="text-primary-500">Pro</span>
              </span>
            </Link>
            ...
            <div className="flex space-x-4">
              ...
              <a
                href="https://linkedin.com/company/lasercalcpro"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 transition-colors hover:text-primary-500"
                aria-label="LinkedIn"
              ...
              <a
                href="https://github.com/lasercalcpro"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 transition-colors hover:text-primary-500"
                aria-label="GitHub"
          ...
          {/* Tools Column */}
          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">{t.footer.sections.tools}</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/blog/tutorials" className="transition-colors hover:text-primary-500">
          ...
          {/* Company Column */}
          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">{t.footer.sections.company}</h3>
            <ul className="space-y-2 text-sm">
              <li>
            ...
            <h3 className="mb-4 mt-6 text-lg font-semibold text-white">{t.footer.sections.legal}</h3>
            <ul className="space-y-2 text-sm">
              <li>
              ...
              <li>
                <Link href="/disclaimer" className="transition-colors hover:text-primary-500">
      ...
      <div className="border-t border-gray-800">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <p className="text-center text-xs text-gray-500 md:text-right">{t.footer.disclaimer}</p>
          </div>
        </div>
      </div>
    </footer>
