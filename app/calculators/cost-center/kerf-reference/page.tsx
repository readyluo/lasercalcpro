              ...
              <div className="card sticky top-24">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <Input {...register('nozzleDiameter')} label="Nozzle (e.g., 2.0mm_nozzle)" error={errors.nozzleDiameter?.message} required />
                    <Input {...register('cuttingLengthMeters', { valueAsNumber: true })} type="number" step="0.1" label="Cutting Length (m, optional)" error={errors.cuttingLengthMeters?.message} />
                  </div>

                  <Button type="submit" variant="primary" size="lg" className="w-full" leftIcon={<CalculatorIcon className="h-5 w-5" />}>Calculate</Button>
                </form>
              </div>
            </div>
